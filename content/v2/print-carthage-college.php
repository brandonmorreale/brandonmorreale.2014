...
<title>Carthage College - Print Design | Brandon Morreale – Creative Designer, Art Director, Chicagoan</title>
...
<div id="main">
  ...
  <div class="sub-main">
    ...
    <h2><p class="project-title">Carthage Art Department</p></h2>
      <h3><p class="categories" >Print Design&nbsp;&nbsp; <img src="img/x.gif" alt="X">&nbsp;&nbsp; Art Direction  &nbsp;&nbsp; <img src="img/x.gif" alt="X">&nbsp;&nbsp; Photography </p></h3>
    
  </div>
  <div id="pagecontent">
    <div id="content-left">
      <p>No frills here. Bold imagery, bold type, and heavy contrast helped these posters to stand out among notifications on campus billboards, promoting the Carthage College senior design showcase.</p>
      ...
      <div class="slideshow">
       <img class="gallery" src="img/print-ccart-1.jpg" alt="Carthage Design Posters" >
    <img class="gallery" src="img/print-ccart-2.jpg" alt="Carthage Design Posters" >
    <img class="gallery" src="img/print-ccart-3.jpg" alt="Carthage Design Posters" >
    <img class="gallery" src="img/print-ccart-4.jpg" alt="Carthage Design Posters" >
    <img class="gallery" src="img/print-ccart-5.jpg" alt="Carthage Design Posters" >
    </div>
