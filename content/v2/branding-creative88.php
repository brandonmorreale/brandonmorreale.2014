...
<title>Creative88 - Branding | Brandon Morreale – Creative Designer, Art Director, Chicagoan</title>
...
<div id="main">
  ...
  <div class="sub-main">
    ...
    <h2><p class="project-title">Creative 88</p></h2>
      <h3><p class="categories" >Branding Design&nbsp;&nbsp; <img src="img/x.gif" alt="X">&nbsp;&nbsp; Art Direction </p></h3>
    
  </div>
  <div id="pagecontent">
    <div id="content-left">
      <p>Creative 88 is a social media and digital agency focusing on online advertising, social media integration, and digital presence. As a startup, they sought a logo that represented their message and appealed to potential clients. The logo that was born is simple and creative, yet bold enough to make a statement.</p>
      ...
      <div class="slideshow">
       <img class="gallery" src="img/branding-s88-1.jpg" alt="Creative88 Branding" >
    <img class="gallery" src="img/branding-s88-2.jpg" alt="Creative88 Branding" >
    </div>
