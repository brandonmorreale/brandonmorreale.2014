...
<title>Tully Electric - Branding | Brandon Morreale – Creative Designer, Art Director, Chicagoan</title>
...
<div id="main">
  ...
  <div class="sub-main">
    ...
    <h2><p class="project-title">Tully Electric</p></h2>
      <h3><p class="categories" >Branding Design&nbsp;&nbsp; <img src="img/x.gif" alt="X">&nbsp;&nbsp; Art Direction </p></h3>
    
  </div>
  <div id="pagecontent">
    <div id="content-left">
    
      <p>Roger Tully of TLE Electric realized that he had a problem on his hands—his logo was suffering from the same clip-art chaos plaguing so many businesses in the trade industry. When installing high-end lighting systems in residential homes, he wanted his crew to represent a company that was in touch with today's style and trends.</p>
<p>Tully's logo is a huge hit—its clever and recognizable image is memorable to customers who have seen it in their driveway, and to potential customers passing it on the road.</p>
...
<div class="slideshow">
       <img class="gallery" src="img/branding-tully-1.jpg" alt="Tully Electric Branding" >  
       <img class="gallery" src="img/branding-tully-2.jpg" alt="Tully Electric Branding" >  
       <img class="gallery" src="img/branding-tully-3.jpg" alt="Tully Electric Branding" >   
</div> 
