...
<title>Sodick Plustech - Web Design | Brandon Morreale – Creative Designer, Art Director, Chicagoan</title>
...
<div id="main">
  ...
  <div class="sub-main">
    ...
    <h2><p class="project-title">Sodick Plustech</p></h2>
      <h3><p class="categories">Website Design&nbsp;&nbsp; <img src="img/x.gif" alt="X">&nbsp;&nbsp; Art Direction &nbsp;&nbsp;<img src="img/x.gif" alt="X">&nbsp;&nbsp; Front-End Programming</p></h3>
    
  </div>
  <div id="pagecontent">
    <div id="content-left">
    
      <p>Sodick Plustech had created a phenomenal product, and needed a website that exemplified its high standards. This B2B boutique company provided us with a challenge—creating a consumer feel for an industrial product.  What developed was a site with all the style of a corporate-consumer website, which tastefully provided all of the information required to promote their product.</p>
      ...
      <div class="slideshow">
       <img src="img/web-sodick-2.jpg" alt="Sodick Plustech Website" width="640" height="923" class="gallery" >
    <img class="gallery" src="img/web-sodick-3.jpg" alt="Sodick Plustech Website" >
    <img class="gallery" src="img/web-sodick-5.jpg" alt="Sodick Plustech Website" >
    <img class="gallery" src="img/web-sodick-4.jpg" alt="Sodick Plustech Website" >
    </div>
