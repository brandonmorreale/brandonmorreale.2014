...
<title>StudioM - Print Design | Brandon Morreale – Creative Designer, Art Director, Chicagoan</title>
...
<div id="main">
  ...
  <div class="sub-main">
    ...
    <h2><p class="project-title">StudioM Dance Company</p></h2>
      <h3><p class="categories" >Print Design&nbsp;&nbsp; <img src="img/x.gif" alt="X">&nbsp;&nbsp; Art Direction&nbsp;&nbsp; <img src="img/x.gif" alt="X">&nbsp;&nbsp; Photography </p></h3>
    
  </div>
  <div id="pagecontent">
    <div id="content-left">
      <p>To promote their company in an age of High School Musical and music videos, StudioM wanted to go back to the basics—reminding dancers and parents that the fundamentals of dance are the most important thing they can teach young women. This campaign kept StudioM's bold identity intact, while promoting the company through a classic yet visually appealing style.</p>
      ...
      <div class="slideshow">
       <img class="gallery" src="img/print-studiom-1.jpg" alt="StudioM Posters" >
    <img class="gallery" src="img/print-studiom-2.jpg" alt="StudioM Posters" >
    <img class="gallery" src="img/print-studiom-3.jpg" alt="StudioM Posters" >
    <img class="gallery" src="img/print-studiom-4.jpg" alt="StudioM Posters" >
    </div>
