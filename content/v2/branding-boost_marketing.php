...
<title>Boost Marketing - Branding | Brandon Morreale – Creative Designer, Art Director, Chicagoan</title>
...
<div id="main">
  ...
  <div class="sub-main">
    ...
    <h2><p class="project-title">Boost Marketing</p></h2>
  ...
  <div id="pagecontent">
    <div id="content-left">
      ...
      <p>Boost Marketing went through a rebrand in the fall of 2009, when they moved into a new, larger office. In order to energize their brand in a struggling economy, Boost created a bolder, more creative persona, representing themselves as a digital agency. Using vibrant reds and a more contemporary style, they stepped into their new office with a new attitude and a new identity.</p>
      ...
      <div class="slideshow" ">
       <img class="gallery" src="img/branding-boost-1.jpg" alt="Boost Marketing Branding" >
    <img class="gallery" src="img/branding-boost-1a.jpg" alt="Boost Marketing Branding" >
    <img class="gallery" src="img/branding-boost-2.jpg" alt="Boost Marketing Branding" >
    </div>
    </div>
