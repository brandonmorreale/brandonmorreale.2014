...
<title>Enshu USA - Print Design | Brandon Morreale – Creative Designer, Art Director, Chicagoan</title>
...
<div id="main">
  ...
  <div class="sub-main">
    ...
    <h2><p class="project-title">Enshu USA</p></h2>
      <h3><p class="categories" >Print Design&nbsp;&nbsp; <img src="img/x.gif" alt="X">&nbsp;&nbsp; Art Direction </p></h3>
    
  </div>
  <div id="pagecontent">
    <div id="content-left">
    
      <p>The GE90H is the biggest machine that Enshu has ever created. This graphic was designed to showcase the machine, and only the machine—no bones about it. The bold headline, combined with a graphic quality that had never been seen before in the industry, helped to make the project and its accompanying ad a critical success.</p>
      ...
      <div class="slideshow">
       <img class="gallery" src="img/print-enshu-1.jpg" alt="Enshu Advertising" >
    <img class="gallery" src="img/print-enshu-3.jpg" alt="Enshu Advertising" >
    <img class="gallery" src="img/print-enshu-2.jpg" alt="Enshu Advertising" >
    </div>
