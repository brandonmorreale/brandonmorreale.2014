...
<title>Evo Exhibits - Web Design | Brandon Morreale – Creative Designer, Art Director, Chicagoan</title>
...
<div id="main">
  ...
  <div class="sub-main">
    ...
    <h2><p class="project-title">Evo Exhibits</p></h2>
  ...
  <div id="pagecontent">
    <div id="content-left">
      ...
      <p>I designed Evo Exhibits' first website when they were a startup, looking to break into the exhibit industry. However, I was not surprised when their website exploded with traffic, quickly becoming an incredibly useful sales tool. Before redesigning their site, I carefully analyzed how their site was being used by clients, creating a plan to guide users through the site.</p>
<p>What developed out of this pre-planning was a tool that functioned simultaneously as an online presence and product catalog—directing users strategically through the site to maximize their exposure to product information, while offering multiple outlets along the way, directing users to important points and options.</p>
...
<div class="slideshow">
       <img class="gallery" src="img/web-evo-2.jpg" alt="Evo Exhibits Website" >
    <img class="gallery" src="img/web-evo-3.jpg" alt="Evo Exhibits Website" >
    <img class="gallery" src="img/web-evo-4.jpg" alt="Evo Exhibits Website" >
    <img class="gallery" src="img/web-evo-5.jpg" alt="Evo Exhibits Website" >
    </div>
