...
<p>Other interests include: NPR, Retro video games, 1980's urban landscapes, anything from Aaron Sorkin, the early history of tech giants, Nick Hornby novels, WTF with Marc Maron, and OPRF. </p>
<p>Despite my current residence I am also an avid Chicago sports fan.</p>		
		</div>
		<div class="twentyfive">
			<h2>Work</h2>
			<ul class="worklist">
				<li>
					<span class="job">Lightburn Designs</span>
					<span class="title">Web Designer + Front-End Developer</span>
					<span class="local">Milwaukee, WI</span>
					<span class="date">2012-Current</span>
					<p>Web/UX designer and front-end developer for a variety of local, regional, and national companies. In addition, responsibilities include CSS3 and HTML5 development, cross browser testing, and bug testing in a .Net MVC environment.</p>
				</li>
				<li>
					<span class="job">The Land of Nod</span>
					<span class="title">Digital Media Designer</span>
					<span class="local">Chicago, IL</span>
					<span class="date">2010-2012</span>
					<p>In-house web + digital designer in charge of creating all outgoing digital marketing materials  including: daily email design/development and web advertising, as well as develop new branding materials for digital and print production. Worked with the Crate & Barrel development team to implement new UI and mobile designs through user testing. Implemented new identity across all digital materials  in 2011.</p>
				</li>
				<li>
		...
		<div class="twentyfive">
			...
			<ul class="personallist">
				<li class="contact">
					<span class="location"><i class="icon-map-marker"></i> Milwaukee, Wisconsin</span>
					<span class="email"><i class="icon-inbox"></i> <a href="mailto:brandon@thisispartone.com">brandon@thisispartone.com</a></span>
				</li>
				<li class="education">
